 ...
 * Charge le fichier relax/index.html depuis les assets
 * Supporte le mode plein écran immersif
 */
class RelaxWebViewActivity : AppCompatActivity() {
    
    private lateinit var webView: WebView
    
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_relax_webview)
    ...
    private fun setupWebView() {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView?, url: String?) {
                ...
                Log.d("RelaxWebView", "Page chargée: $url")
            }
            ...
            override fun onReceivedError(view: WebView?, errorCode: Int, description: String?, failingUrl: String?) {
                ...
                Log.e("RelaxWebView", "Erreur WebView: $description")
            }
        }
        ...
        webView.webChromeClient = object : WebChromeClient() {
            override fun onProgressChanged(view: WebView?, newProgress: Int) {
                ...
                Log.d("RelaxWebView", "Progression: $newProgress%")
            }
        }
    }
    
    /**
     * Chargement du fichier HTML via le WebServer existant
     */
    private fun loadLocalHtml() {
        try {
            val url = "http://localhost:8888/relax/index.html"
            webView.loadUrl(url)
            Log.d("RelaxWebView", "Chargement de: $url")
        } catch (e: Exception) {
            Log.e("RelaxWebView", "Erreur lors du chargement du fichier HTML", e)
        }
    }
